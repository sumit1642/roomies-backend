...
import { getReportQueueSchema, getReportHistorySchema, resolveReportSchema } from "../validators/report.validators.js";
...
reportRouter.get("/history", authenticate, ...requireAdmin, validate(getReportHistorySchema), rc.getReportHistory);
