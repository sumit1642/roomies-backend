...
{
  "notificationIds": [
    "31f907ca-df84-4f9d-9c4a-fd67eb1dfe7d",
    "efb6d828-3725-4caf-aa15-5a8ec749f590"
  ]
}
```
...
- Supplying another user's notification IDs does not update those rows because the update is scoped to the authenticated recipient.
